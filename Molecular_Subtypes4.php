...
// =============================================
// Browse tab：依 Subtype / Other 篩選並顯示代謝物列表
// =============================================
...
<head>
    ...
    <style>
        ...
        /* ── Browse tab：Total Records 與分頁並排靠左 ── */
        .browse-meta-bar {
            display: flex;
            align-items: center;
            flex-wrap: wrap;
        ...
        .browse-card .data-table thead th {
            background: none;
            color: #1a202c;
            font-weight: 700;
            text-align: left;
        ...
        .browse-card .data-table tbody td {
            padding: 10px 12px;
            border-bottom: 1px solid #edf2f7;
        }
...
<main class="analysis-container">
    ...
    <nav class="nav-tabs" id="metab-tabs">
        <button class="tab<?= $browseTabActive ? ' active' : '' ?>" data-target="sec-identification">Browse</button>
        <button class="tab<?= $browseTabActive ? '' : ' active' ?>" data-target="sec-molecular">Analysis</button>
        <button class="tab"        data-target="sec-prognosis">References</button>
    </nav>

    <!-- Browse：依 Subtype / Other 篩選顯示代謝物列表 -->
    <section id="sec-identification" class="tab-panel<?= $browseTabActive ? ' active' : '' ?>">
    ...
    <!-- Analysis：目前的內容 -->
    <section id="sec-molecular" class="tab-panel<?= $browseTabActive ? '' : ' active' ?>">

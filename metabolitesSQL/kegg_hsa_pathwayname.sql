...
-- 傾印  資料表 metabolites.kegg_hsa_pathwayname 結構
CREATE TABLE IF NOT EXISTS `kegg_hsa_pathwayname` (
  `pathway_id` varchar(50) NOT NULL,
  `pathway_name` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- 正在傾印表格  metabolites.kegg_hsa_pathwayname 的資料：~370 rows (近似值)
INSERT INTO `kegg_hsa_pathwayname` (`pathway_id`, `pathway_name`) VALUES
	...
	('hsa03260', 'Virion - Human immunodeficiency virus'),
	('hsa03271', 'Virion - Rotavirus'),
	('hsa03264', 'Virion - Flavivirus and Alphavirus'),
	('hsa03265', 'Virion - Ebolavirus'),
	('hsa03273', 'Virion - Lassa virus and SFTS virus'),
	('hsa03272', 'Virion - Hepatitis viruses'),
	('hsa03266', 'Virion - Herpesvirus'),
	('hsa03267', 'Virion - Adenovirus'),
